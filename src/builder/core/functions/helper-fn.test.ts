...
} from "~/builder/core/functions/helper-fn";

describe("getClassValueAndUnit", () => {
  test("should return", () => {
    expect(getClassValueAndUnit("")).toEqual({ value: "", unit: "" });
    expect(getClassValueAndUnit("w-[33px]")).toEqual({
      value: "33",
      unit: "px",
    });
    expect(getClassValueAndUnit("w-[25%]")).toEqual({ value: "25", unit: "%" });
    expect(getClassValueAndUnit("w-[25.33%]")).toEqual({
      value: "25.33",
      unit: "%",
    });
    expect(getClassValueAndUnit("w-[25vh]")).toEqual({
      value: "25",
      unit: "vh",
    });
    expect(getClassValueAndUnit("w-[25vw]")).toEqual({
      value: "25",
      unit: "vw",
    });
    expect(getClassValueAndUnit("w-[25em]")).toEqual({
      value: "25",
      unit: "em",
    });
    expect(getClassValueAndUnit("w-[25rem]")).toEqual({
      value: "25",
      unit: "rem",
    });
    expect(getClassValueAndUnit("w-20")).toEqual({ value: "80", unit: "px" });
    expect(getClassValueAndUnit("-m-20")).toEqual({ value: "-80", unit: "px" });
    expect(getClassValueAndUnit("-m-[20px]")).toEqual({
      value: "-20",
      unit: "px",
    });
  });
...
describe("Get height tailwind values", () => {
  test("should return", () => {
    ...
    expect(getTwClassValue("translate-x-1/2")).toEqual({
      value: "50",
      unit: "%",
    });
    expect(getTwClassValue("translate-x-1.5")).toEqual({
      value: "0.375",
      unit: "rem",
    });
    expect(getTwClassValue("-translate-x-1.5")).toEqual({
    ...
    expect(getTwClassValue("-scale-x-150")).toEqual({
      value: "-1.5",
      unit: "-",
    });
...
describe("Get min width tailwind values", () => {
  test("should return", () => {
    expect(getMinWidthTwClassValue("min-w-0")).toEqual({
      value: "0",
      unit: "px",
    });
    expect(getMinWidthTwClassValue("min-w-full")).toEqual({
      value: "100",
      unit: "%",
    });
  });
...
describe("get Value And Unit For Tw Class", () => {
  test("should return", () => {
    ...
    expect(getValueAndUnitForTWClass("w-20")).toEqual({
      value: "80",
      unit: "px",
    });
  });
...
describe("get negative values", () => {
  test("should return", () => {
    expect(getValueAndUnitForTWClass("-m-10")).toEqual({
      value: "-40",
      unit: "px",
    });
  });
...
describe("get border values", () => {
  test("should return", () => {
    expect(getValueAndUnitForTWClass("border-0")).toEqual({
      value: "0",
      unit: "px",
    });
    expect(getValueAndUnitForTWClass("border-8")).toEqual({
      value: "8",
      unit: "px",
    });
  });
