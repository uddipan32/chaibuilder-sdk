  ...
  "inline-flex leading-tight items-center gap-1 text-[11px] cursor-pointer rounded-md border px-2.5 py-0.5 transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        active: "text-primary-foreground border-primary bg-primary px-2 py-px font-light",
        inactive: "text-foreground border-border bg-secondary hover:bg-accent px-2 py-px font-light",
      },
    },
    defaultVariants: {
      variant: "default",
