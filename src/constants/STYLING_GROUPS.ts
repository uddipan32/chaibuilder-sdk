...
export const SETTINGS_SECTIONS = [
  {
    ...
    items: [
      ...
      //       type: "arbitrary",
      //       property: "lineHeight",
      //       label: "typography.height",
      //       units: BASIC_UNITS.concat("-"),
      //     },
    ...
    items: [
      {
        ...
        items: [
          {
            type: "arbitrary",
            label: "size.min_width",
            units: BASIC_UNITS.concat("auto"),
            property: "minWidth",
          },
          {
            type: "arbitrary",
            label: "size.min_height",
            units: BASIC_UNITS.concat("auto"),
            property: "minHeight",
          },
        ],
      },
      {
        ...
        items: [
          {
            type: "arbitrary",
            label: "size.max_width",
            units: BASIC_UNITS.concat("auto"),
            property: "maxWidth",
          },
          {
            type: "arbitrary",
            label: "size.max_height",
            units: BASIC_UNITS.concat("auto"),
            property: "maxHeight",
          },
        ],
    ...
    items: [
      ...
      },
      {
        ...
        items: [
          {
            type: "dropdown",
            label: "display.flex_direction",
            property: "flexDirection",
          },
          {
            type: "dropdown",
            label: "display.flex_wrap",
            property: "flexWrap",
          },
          {
            type: "dropdown",
            label: "display.justify_content",
            property: "justifyContent",
          },
          {
            type: "dropdown",
            label: "display.align_content",
            property: "alignContent",
          },
          {
            type: "dropdown",
            label: "display.align_items",
            property: "alignItems",
          },
          {
            styleType: "multiple",
      ...
      },
      {
        ...
        items: [
          {
            type: "range",
            label: "display.grid_columns",
            property: "gridColumns",
          },
          { type: "range", label: "display.grid_rows", property: "gridRows" },
          {
            type: "dropdown",
            label: "display.grid_auto_flow",
            property: "gridAutoFlow",
          },
          {
            type: "dropdown",
            label: "display.grid_auto_cols",
            property: "gridAutoColumns",
          },
          {
            type: "dropdown",
            label: "display.grid_auto_rows",
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            label: "typography.thickness",
          },
          {
            type: "dropdown",
            property: "textTransform",
            label: "typography.transform",
          },
        ],
      },
      {
        ...
        items: [
          {
            type: "dropdown",
            property: "whitespace",
            label: "typography.whitespace",
          },
          {
            type: "dropdown",
            property: "wordbreak",
            label: "typography.wordbreak",
          },
        ],
      },
    ],
    ...
    items: [
      ...
      },
      {
        ...
        items: [
          {
            type: "color",
            label: "background.from_color",
            property: "fromColor",
          },
          {
            type: "color",
            label: "background.via_color",
            property: "viaColor",
          },
    ...
    items: [
      ...
      { type: "dropdown", label: "border.style", property: "borderStyle" },
      {
        ...
        items: [
          ...
          {
            type: "color",
            label: "border.divide_color",
            property: "divideColor",
          },
          {
            type: "dropdown",
            label: "border.divide_style",
      ...
      },
      {
        ...
        items: [
          {
            type: "range",
            label: "border.outline_width",
            property: "outlineWidth",
          },
          {
            type: "range",
            label: "border.outline_offset",
            property: "outlineOffset",
          },
          {
            type: "dropdown",
            label: "border.outline_style",
      ...
      },
      {
        ...
        items: [
          ...
          {
            type: "range",
            label: "border.ring_offset_width",
            property: "ringOffsetWidth",
          },
          {
            type: "color",
            label: "border.ring_offset_color",
    ...
    items: [
      ...
      { type: "dropdown", label: "effect.cursor", property: "cursor" },
      {
        ...
        items: [
          {
            type: "dropdown",
            label: "effect.mix_blend",
            property: "mixBlendMode",
          },
          {
            type: "dropdown",
            label: "effect.bg_blend",
            property: "bgBlendMode",
          },
        ],
      },
      {
